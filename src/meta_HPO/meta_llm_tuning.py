...
sys.path.insert(
    0, r"C:\Users\user.IBRAHIM-IK-SZHE\Meta_LLM_HPO\hyperopt-llm-project\src"
)
...
class LLMTuning:
    def __init__(self,model_name,experiment_name,clean_train,clean_test,target_cols,llm_name,model_description,temperature=0.15):
    ...
    # 2. Tools
    # ==========================================================================
    def run_bilstm(self, params: dict) -> float:
        """Runs Bi-LSTM and returns RMSE"""
        results = self.pipeline.run("Bi-LSTM", params)
    ...
    def record_trials(
        ...
        reasoning,
        llm_name,
        base_dir=r"C:\Users\user.IBRAHIM-IK-SZHE\Meta_LLM_HPO\hyperopt-llm-project\data\LLM_trials_memory",
    ):
        record = {
            "params": params,
            "rmse": rmse,
    ...
    def hpo_optimization(
        ...
        for i in range(n_trials):
            ...
            # Run model
            rmse = self.run_bilstm(parsing["suggested_params"])
            print("RMSE:", rmse)
